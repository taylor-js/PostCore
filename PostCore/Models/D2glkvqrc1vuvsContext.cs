...
public partial class D2glkvqrc1vuvsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Amcontent>(entity =>
        {
            ...
            entity.Property(e => e.Assetcontentdateassigned).HasColumnName("assetcontentdateassigned");
            ...
            entity.Property(e => e.Uniqueassetidcont).HasColumnName("uniqueassetidcont");

            entity.HasOne(d => d.UniqueassetidcontNavigation).WithMany(p => p.Amcontents)
        ...
        modelBuilder.Entity<Amdistrib>(entity =>
        {
            ...
            entity.Property(e => e.Assetdistributiondateassigned).HasColumnName("assetdistributiondateassigned");
            ...
            entity.Property(e => e.Assetdistributionquantity).HasColumnName("assetdistributionquantity");
            entity.Property(e => e.Uniqueassetiddistr).HasColumnName("uniqueassetiddistr");

            entity.HasOne(d => d.UniqueassetiddistrNavigation).WithMany(p => p.Amdistribs)
        ...
        {
            entity.HasKey(e => e.Uniqueassetid).HasName("assetmgmt_pkey");
            ...
            entity.Property(e => e.Assetdate).HasColumnName("assetdate");
            ...
            entity.Property(e => e.Assetpurchaseordernumber).HasColumnName("assetpurchaseordernumber");
            entity.Property(e => e.Assettype)
                .HasMaxLength(50)
                .HasColumnName("assettype");
            entity.Property(e => e.Assetworkordernumber).HasColumnName("assetworkordernumber");
        });
